...
module fifo_bridge (
  ...
  wire       [7:0]    ft245Fifo_fifoDataWrite;
  wire                ft245Fifo_fifoDataOe;
  wire                ft245Fifo_fifoRdN;
  wire                ft245Fifo_fifoWrN;
  wire       [7:0]    ft245Fifo_rxDataOut;
  wire                ft245Fifo_rxDataValid;
  wire                ft245Fifo_txBusy;
  ...
  wire       [7:0]    baudSwitchCpb;
  wire       [1:0]    baudSwitchPreset;
  ...
  ft245_fifo ft245Fifo (
    .fifoDataRead  (fifoDataRead[7:0]           ), //i
    .fifoDataWrite (ft245Fifo_fifoDataWrite[7:0]), //o
    .fifoDataOe    (ft245Fifo_fifoDataOe        ), //o
    .fifoRxfN      (fifoRxfN                    ), //i
    .fifoTxeN      (fifoTxeN                    ), //i
    .fifoRdN       (ft245Fifo_fifoRdN           ), //o
    .fifoWrN       (ft245Fifo_fifoWrN           ), //o
    .rxDataOut     (ft245Fifo_rxDataOut[7:0]    ), //o
    .rxDataValid   (ft245Fifo_rxDataValid       ), //o
    .txDataIn      (txDataR[7:0]                ), //i
    .txDataValid   (txValidR                    ), //i
    .txBusy        (ft245Fifo_txBusy            ), //o
    .rxSuppress    (fifoRxSuppress              ), //i
    .clk           (clk                         ), //i
    .resetn        (resetn                      )  //i
  );
  Crc8 uRxCrc (
    ...
    .io_dataIn (ft245Fifo_rxDataOut[7:0]), //i
  ...
  assign baudSwitchCpb = 8'h0;
  assign baudSwitchPreset = 2'b00;
  assign fifoDataWrite = ft245Fifo_fifoDataWrite;
  assign fifoDataOe = ft245Fifo_fifoDataOe;
  assign fifoRdN = ft245Fifo_fifoRdN;
  assign fifoWrN = ft245Fifo_fifoWrN;
  assign rxFrameErr = 1'b0;
  assign fifoRxSuppress = (((((txState != TX_IDLE) || (rxState == RX_EXEC1)) || (rxState == RX_EXEC2)) || txStart) || txStartD);
  ...
  assign uartActivity = (ft245Fifo_rxDataValid || ft245Fifo_txBusy);
  assign when_UartBridge_l366 = ((wrSectorsReady != 5'h0) && (! emmcWrSectorValidR));
  assign when_UartBridge_l398 = (ft245Fifo_rxDataValid || (rxState == RX_IDLE));
  ...
  assign when_UartBridge_l435 = (ft245Fifo_rxDataOut == 8'haa);
  assign _zz_rxPayloadCnt = {rxPayloadLen[15 : 8],ft245Fifo_rxDataOut};
  ...
  assign _zz_wrSectorsLeft = {rxPayloadBuf_4,ft245Fifo_rxDataOut};
  ...
  assign when_UartBridge_l783 = (! ft245Fifo_txBusy);
  assign when_UartBridge_l790 = ((! ft245Fifo_txBusy) && (! txValidR));
  assign when_UartBridge_l799 = ((! ft245Fifo_txBusy) && (! txValidR));
  assign when_UartBridge_l808 = ((! ft245Fifo_txBusy) && (! txValidR));
  assign when_UartBridge_l817 = ((! ft245Fifo_txBusy) && (! txValidR));
  assign when_UartBridge_l825 = (txPayloadLen == 16'h0);
  assign when_UartBridge_l833 = ((! ft245Fifo_txBusy) && (! txValidR));
  assign when_UartBridge_l861 = ((! ft245Fifo_txBusy) && (! txValidR));
  assign when_UartBridge_l869 = ((! ft245Fifo_txBusy) && (! txValidR));
    ...
    if(!resetn) begin
      ...
      if(when_UartBridge_l427) begin
        ...
        if(when_UartBridge_l431) begin
          protocolErrorR <= 1'b0;
          earlyWriteDispatched <= 1'b0;
          if(ft245Fifo_rxDataValid) begin
          ...
          if(when_UartBridge_l441) begin
            if(ft245Fifo_rxDataValid) begin
              rxCmdId <= ft245Fifo_rxDataOut;
              isWriteCmd <= (ft245Fifo_rxDataOut == CMD_WRITE_SECTOR);
              rxCrcEnR <= 1'b1;
              rxState <= RX_LEN_H;
            end
          end else begin
            if(when_UartBridge_l449) begin
              if(ft245Fifo_rxDataValid) begin
                rxPayloadLen[15 : 8] <= ft245Fifo_rxDataOut;
                rxCrcEnR <= 1'b1;
                rxState <= RX_LEN_L;
              end
            end else begin
              if(when_UartBridge_l456) begin
                if(ft245Fifo_rxDataValid) begin
                  rxPayloadLen[7 : 0] <= ft245Fifo_rxDataOut;
                  rxCrcEnR <= 1'b1;
                ...
                if(when_UartBridge_l472) begin
                  if(ft245Fifo_rxDataValid) begin
                    ...
                    if(when_UartBridge_l477) begin
                      if(_zz_1[0]) begin
                        rxPayloadBuf_0 <= ft245Fifo_rxDataOut;
                      end
                      if(_zz_1[1]) begin
                        rxPayloadBuf_1 <= ft245Fifo_rxDataOut;
                      end
                      if(_zz_1[2]) begin
                        rxPayloadBuf_2 <= ft245Fifo_rxDataOut;
                      end
                      if(_zz_1[3]) begin
                        rxPayloadBuf_3 <= ft245Fifo_rxDataOut;
                      end
                      if(_zz_1[4]) begin
                        rxPayloadBuf_4 <= ft245Fifo_rxDataOut;
                      end
                      if(_zz_1[5]) begin
                        rxPayloadBuf_5 <= ft245Fifo_rxDataOut;
                      end
                      if(_zz_1[6]) begin
                        rxPayloadBuf_6 <= ft245Fifo_rxDataOut;
                      end
                      if(_zz_1[7]) begin
                        rxPayloadBuf_7 <= ft245Fifo_rxDataOut;
                      end
                    end
                    ...
                    if(when_UartBridge_l492) begin
                      emmcWrDataR <= ft245Fifo_rxDataOut;
                      emmcWrEnR <= 1'b1;
                  ...
                  if(when_UartBridge_l545) begin
                    if(ft245Fifo_rxDataValid) begin
                      rxCrcMatch <= (ft245Fifo_rxDataOut == uRxCrc_io_crcOut);
                      rxState <= RX_EXEC1;
                    end
                  end else begin
