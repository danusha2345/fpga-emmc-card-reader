// Top Module - eMMC Card Reader on Tang Nano 9K
// GW1NR-9 QN88P
// Updated for SpinalHDL-generated sub-modules (camelCase ports, split tristate)
// Supports 4-bit eMMC bus width (DAT1-3 active when physically wired)

module top (
    input  wire       clk_27m,      // 27 MHz crystal oscillator

    // UART (via BL702 USB bridge)
    output wire       uart_tx,
    input  wire       uart_rx,
    ...
    // Reset
    // =========================================================
    // btn_s1 is active low; combine with PLL lock
    wire rst_n_raw = btn_s1 & pll_lock;

    // Synchronize reset to sys_clk domain
    reg [2:0] rst_sync;
    ...
    // SpinalHDL uses split in/out/oe instead of inout
    // =========================================================
    ...
    // =========================================================
    // UART Bridge (SpinalHDL-generated)
    // =========================================================
    wire uart_activity;
    wire protocol_error;
