...
impl Superblock {
    pub fn parse(data: &[u8]) -> Result<Self> {
        ...
        Ok(Self {
            inode_count, block_count, free_blocks, free_inodes,
            block_size, blocks_per_group, inodes_per_group,
            inode_size, desc_size, num_groups, uuid, uuid_str,
            volume_name, is_64bit, has_extents, has_journal,
            metadata_csum, csum_seed,
        })
    }
}
